...
| Coach messages and summaries | proposed rolling 12 months, unless the user deletes earlier | rolling expiry, thread deletion, or account deletion | Final product need, user controls, and expiry job are not approved |
