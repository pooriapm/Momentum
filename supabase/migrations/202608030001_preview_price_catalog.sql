-- Public alpha price hypotheses. Checkout and Iranian AI service remain disabled.
-- Updating these values requires a new reviewed migration; production `db push`
-- intentionally does not depend on local seed execution.
