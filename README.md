...
حرفه‌ای برای این مرحله non-blocking و به کار پس از R2 منتقل شده است. R2.2 تا R2.5 نیز
به‌صورت محلی بسته شده‌اند. قدم فعال R2.6 (metrics و release evidence) است؛ معیارهای دقیق در
